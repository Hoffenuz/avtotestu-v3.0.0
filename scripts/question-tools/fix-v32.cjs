// ============================================================================
// fix-v32.cjs — v32 tekshiruvida topilgan xatolar. SAVOL DOIRASIDA ishlaydi.
//
//   node scripts/question-tools/fix-v32.cjs         # quruq yurish
//   node scripts/question-tools/fix-v32.cjs apply   # yozadi
// ============================================================================
...
const FIXES = {
  t_32_q_1: [{ lang: 'ru', bad: 'Сколько основные понятий', good: 'Сколько основных понятий', why: '"Сколько" so\'zi genitiv kelishikni talab qiladi ("основных", "основные" emas).' }],
  t_32_q_17: [{ lang: 'ru', bad: 'без бокового прицепаных арок.', good: 'без бокового прицепа.', why: 'uz: "кажаваси бўлмаган" = "без бокового прицепа" (sidecar\'siz). "ных арок" — ma\'nosiz qoldiq.' }],
};
...
if (!APPLY) console.log('\nYozish uchun: node scripts/question-tools/fix-v32.cjs apply');
