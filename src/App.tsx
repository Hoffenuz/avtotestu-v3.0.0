...
const PravaOlish = lazyWithRetry(() => import("./pages/PravaOlish"));
...
const DesktopApp = lazyWithRetry(() => import("./pages/DesktopApp"));
...
const App = () => {
  return (
  /**
   * ErrorBoundary eng tashqarida: ilgari u Suspense va barcha provider lar
   * ichida edi, shuning uchun AuthProvider yoki supabase client init da
          ...
          <Suspense fallback={<div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center'}}><div style={{width:'40px',height:'40px',border:'3px solid #e5e7eb',borderTopColor:'#1e3a8a',borderRadius:'50%',animation:'spin 0.6s linear infinite'}}></div></div>}>
            <Routes>
              ...
              */}
              ...
              <Route path="/prava-olish" element={<PravaOlish />} />
