...
<div className="relative w-full md:w-auto">
  {user && isPremium ? (
    ...
    <span className="absolute -top-2 -right-2 bg-gradient-to-r from-emerald-500 to-green-500 text-white text-xs font-bold px-2.5 py-0.5 rounded-full z-10 shadow-sm">
      {t("common.bepul")}
    </span>
  )}
...
>
  ...
  <span>{t("home.btnMavzuli")}</span>
      ...
      {!(user && isPremium) && (
        <section className="py-8 sm:py-10 md:py-14 bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 dark:from-amber-950/30 dark:via-yellow-950/20 dark:to-orange-950/30 border-y border-yellow-200/60 dark:border-yellow-800/30">
          <div className="max-w-4xl mx-auto px-4">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-yellow-400/20 via-amber-400/15 to-orange-400/20 dark:from-yellow-900/40 dark:via-amber-900/30 dark:to-orange-900/40 border-2 border-yellow-400/40 dark:border-yellow-600/30 shadow-xl shadow-amber-500/10">
              ...
              <div className="absolute -top-10 -right-10 hidden sm:block w-40 h-40 bg-yellow-400/30 rounded-full blur-3xl pointer-events-none" />
              <div className="absolute -bottom-10 -left-10 hidden sm:block w-40 h-40 bg-amber-400/20 rounded-full blur-3xl pointer-events-none" />

              <div className="relative p-4 sm:p-5 md:p-10">
                <div className="flex flex-col md:flex-row items-start gap-4 sm:gap-6">
                  {/* Icon */}
                  <div className="flex-shrink-0">
                    <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-yellow-400 to-amber-600 flex items-center justify-center shadow-lg shadow-amber-500/40 ring-4 ring-yellow-300/30">
                      <Crown className="w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 text-white drop-shadow-sm" />
                    </div>
                  </div>

                  {/* Text */}
                  <div className="flex-1 text-left md:text-left">
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-yellow-500/20 border border-yellow-500/30 text-yellow-700 dark:text-yellow-400 text-[10px] sm:text-xs font-bold uppercase tracking-wide mb-3">
                      <Sparkles className="w-3 h-3" />
                      PRO
                    </div>
                    <h2 className="text-lg sm:text-2xl md:text-3xl font-bold text-foreground mb-2 leading-tight" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                    ...
                    <div className="mt-4 sm:mt-6">
                      <Link to="/pro">
                        <Button className="relative overflow-hidden group bg-gradient-to-r from-yellow-400 to-amber-500 hover:from-yellow-500 hover:to-amber-600 text-white font-bold px-5 sm:px-8 py-4 sm:py-6 text-sm sm:text-lg rounded-2xl shadow-xl shadow-amber-400/40 hover:shadow-amber-400/60 hover:scale-[1.03] transition-all border-0 gap-2 sm:gap-3">
                          <span className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                          <Zap className="w-4 h-4 sm:w-6 sm:h-6 drop-shadow-sm" />
                          <span>Sinab ko'rish</span>
                          <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 opacity-80 hidden sm:inline-block" />
                        </Button>
                      </Link>
                      <p className="text-[11px] sm:text-xs text-muted-foreground mt-2.5 flex items-center gap-1 justify-start">
