...
const Auth = () => {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- handleGoogleLogin/isGoogleLoading intentionally excluded; this fires once when the page loads for trial sign-in
