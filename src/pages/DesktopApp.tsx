...
export default function DesktopApp() {
  ...
  return (
    <MainLayout>
      ...
      {isMobile ? (
        <section className="min-h-[calc(100vh-4rem)] bg-muted/30 flex items-center justify-center py-10 px-4">
          <div className="max-w-md w-full rounded-2xl border border-border bg-card shadow-md p-8 text-center">
      ...
      <section className="min-h-[calc(100vh-4rem)] bg-muted/30 flex items-start py-6 md:py-8">
        <div className="max-w-6xl mx-auto px-4 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10 items-start">
            ...
            <div className="lg:col-span-3 space-y-6">
              <div>
                <span className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wide text-emerald-700 dark:text-emerald-400 bg-emerald-500/10 border border-emerald-500/25 px-2.5 py-1 rounded-full mb-4">
              ...
              <div className="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
                <div className="relative aspect-[16/7] bg-muted flex flex-col items-center justify-center gap-2">
                  <div className="w-11 h-11 rounded-full bg-card shadow-sm flex items-center justify-center border border-border">
            ...
            <div className="lg:col-span-2 lg:-mt-2 self-start">
              <div className="rounded-2xl border border-border bg-card shadow-md p-6 md:p-8 sticky top-16">
