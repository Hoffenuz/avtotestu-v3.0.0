              ...
              <div>
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div className="flex-1">
                    ...
                    <h1 className="text-xl md:text-2xl font-extrabold text-foreground mb-3 leading-tight" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                      {t("pro.heroTitle")}
                    </h1>
                  ...
                  <div className="hidden lg:flex flex-col items-end gap-2 flex-shrink-0">
                    <Button
                      className="h-14 px-8 text-base font-bold rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white border-0 shadow-xl hover:shadow-2xl transition-all duration-300 gap-2.5 hover:scale-105 animate-[gradient_3s_ease-in-out_infinite]"
                      style={{
                        backgroundSize: '200% 200%',
                        animation: 'gradient 3s ease-in-out infinite',
                      }}
                    ...
                    <span className="text-[11px] tracking-[0.25em] uppercase text-muted-foreground/60 pr-1">
                      PRO olish
                    </span>
                  </div>
                </div>
