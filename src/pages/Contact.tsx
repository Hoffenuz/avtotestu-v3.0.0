  ...
  return (
    <MainLayout>
      <SEO 
        ...
        path="/contact"
        keywords="aloqa, bog'lanish, yordam, savol javob, avtotestlar.uz kontakt"
      />
      
      <section className="bg-background pt-8 pb-12 md:pt-12">
        <div className="w-full px-4 md:px-8 lg:px-16">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-6 text-center" style={{ fontFamily: "'Segoe UI', system-ui, -apple-system, sans-serif" }}>
              {t("contact.seoTitle")}
            </h1>
