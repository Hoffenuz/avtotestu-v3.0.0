// NOTE: This file is part of a standalone sub-application located in
// src/pages/mavzuli/. It is NOT imported by the main app (which uses
// src/pages/MavzuliTestlar.tsx + src/components/MavzuliTestInterface.tsx).
// This sub-app has its own package.json, vite.config.js, and index.html.
// The canonical implementation used by the main build is src/pages/mavzuli/src/App.jsx.
// Keep credentials out of source — load from VITE_SUPABASE_URL / VITE_SUPABASE_ANON_KEY.
