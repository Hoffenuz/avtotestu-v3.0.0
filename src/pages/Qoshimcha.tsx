      ...
      <section className="py-10 md:py-14 bg-background">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl md:text-2xl font-bold text-foreground" style={{ fontFamily: "'Segoe UI', system-ui, -apple-system, sans-serif" }}>
            ...
            <div className="rounded-xl border border-amber-200 dark:border-amber-800/40 bg-amber-50 dark:bg-amber-950/20 p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-sm text-foreground mb-1" style={{ fontFamily: "'Segoe UI', system-ui, -apple-system, sans-serif" }}>
                    To'lovni qaytarish
                  </p>
