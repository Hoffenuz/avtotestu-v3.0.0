...
export default function TestIshlash() {
  ...
  return (
    <div className={isDark ? 'dark' : ''}>
      <SEO
        title="Test ishlash — Onlayn YHQ testi 2026"
        description="YHQ onlayn test: 600+ savoldan 20 yoki 50 ta tasodifiy savol. 25 daqiqa, 18/20 o'tish bali. Bepul, ro'yxatsiz — haqiqiy imtihon formatida natijani darhol ko'ring."
        path="/test-ishlash"
