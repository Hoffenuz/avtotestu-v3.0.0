        ...
        <div className="w-full px-2 sm:px-4 md:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
           ...
           <div className="flex items-center gap-4 sm:gap-8 md:gap-12">
              ...
              <Link to="/" aria-label="Avtotestlar - Bosh sahifa" className="flex items-center gap-2 sm:gap-3 ml-2 sm:ml-4">
                <img
                  src="/rasm1.webp"
                  alt="Avtotestlar Logo"
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              {user ? (
                ...
                >
                  <div className="h-8 w-8 rounded-full bg-[hsl(var(--cta-orange))] flex items-center justify-center flex-shrink-0">
